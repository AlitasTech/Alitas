...
// SocketAppProxyServer is the server component of the AppGateway that responds to RPC requests from App.
...
func (p *SocketAppProxyServer) register(bindAddress string) error {
	...
	rpcServer.RegisterName("Alitas", p)
...
// SubmitTx Implements the AppGateway interface
